...
export default function ProjectStatusFilter({ selected, onToggle, propertyAges = [], onTogglePropertyAge, isDesktopView = false }) {
 ...
 <span className="text-[10px] font-semibold tracking-wide text-[#1E1E1E]">Possession Timeline</span>
 </div>
 ...
 <span className="text-[10px] font-semibold tracking-wide text-[#1E1E1E]">Property Condition</span>
 </div>
 <div className="flex flex-wrap items-center gap-1">
